<?php
    ...
    function getTasks($id)
    {
        ...
        <button id="<?php echo $row["id"] ?>"  onclick="edit(this)" class="d-flex button border  w-100 p-1 " data-bs-toggle="modal" data-bs-target="#update">
        <span class="d-none"><?php echo $row["id"].','.$row["title"].','.$row["NameTypes"].','.$row["NamePriority"].','.$row["NameStatus"].','.$row["date"].','.$row["description"]?></span>
            ...
            <div class="text-start col-md-11 ">
                ...
                <div class="fw-bold" id="title"><?php echo $row["title"] ?></div>
                <div class="">
                    <div class="text-gray">#<span><?php echo $row['id']?></span> created in <span id="date"><?php echo $row["date"] ?></span></div>
                    <div class="" id="description"><?php echo  substr($row["description"], 0, 30,); ?></div>
                </div>
                <div class="">
                    <span class="col-md-auto btn btn-primary text-white" id="priority"><?php echo $row["NamePriority"] ?></span>
                    <span class="col-md-auto btn btn-gray text-dark" id="type"><?php echo $row["NameTypes"] ?></span>
